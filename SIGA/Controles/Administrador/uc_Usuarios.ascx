<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Usuarios.ascx.cs" Inherits="SIMGA.Controles.Administrador.uc_Usuarios" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<telerik:RadGrid ID="rgrUsuarios" runat="server" AllowAutomaticDeletes="True" AllowAutomaticInserts="True"
    AllowPaging="True" AllowSorting="True" CellSpacing="0" Culture="es-ES"
    GridLines="None" AllowAutomaticUpdates="True" AllowCustomPaging="True" OnNeedDataSource="rgrUsuarios_NeedDataSource">
    ...
    <MasterTableView CommandItemDisplay="Top"
        EditMode="InPlace" OverrideDataSourceControlSorting="True" DataKeyNames="identificacion">
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rgrUsuarios">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rgrUsuarios"
